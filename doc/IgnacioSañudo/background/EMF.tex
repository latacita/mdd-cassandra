...
Para la creación de meta-modelos EMF [2.3] utiliza dos modelos de meta-datos: Ecore y Genmodel. Ecore contiene la información sobre las clases que se han definido. Genmodel contiene información adicional para la generación del código, por ejemplo la ruta y la información del archivo. Utilizando EMF se pueden crear meta-modelos de forma gráfica muy similar a los diagramas de clases en UML.
EMF permite crear un meta-modelo a través de diferentes medios, por ejemplo, XMI, anotaciones Java, XML o UML. EMF proporciona un framework para almacenar la información del modelo.
