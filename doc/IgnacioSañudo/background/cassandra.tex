...
Esta sección realiza una breve descripción sobre Cassandra, desde su historia, arquitectura, sintaxis y otras características que explican como es el sistema de bases de datos no relacional orientado a columnas escogido para este proyecto de fin de carrera.
...
Cassandra reúne las  tecnologías de sistemas distribuidos de Amazon Dynamo y el modelo de datos BigTable de Google. Por ejemplo, al igual que Dynamo, Cassandra es consistente. Como BigTable, Cassandra proporciona un modelo de datos basado en column families siendo considerado el sistema orientado a columnas más popular. 
