...
Como habíamos descrito en el capitulo anterior la base del proceso de transformación entre modelos parte del meta-modelo. Previo paso a la definición de las reglas de transformación entre modelos necesitamos definir un meta-modelo de origen y un meta-modelo de destino. El meta-modelo de UML 2.0 utilizado en este proyecto como origen de la transformación es el que nos proporciona Epsilon, dicho meta-modelo sigue el estándar de UML 2.0. A parte del meta-modelo de UML nos hace falta un meta-modelo que defina el lenguaje de modelado de Cassandra. Dicho meta-modelo fue proporcionado por Pablo Sánchez Barreiro. Este meta-modelo se construyo por medio de la abstracción de las principales características de Cassandra. El meta-modelo sufrió algunos cambios respecto al inicial debido a exigencias y variantes que sufrió el proyecto. La Figura~\ref{back:fig:metamodeloCassandra} muestra como se ha definido el lenguaje de modelado de Cassandra con EMF, como vemos se puede diseñar un lenguaje de manera muy similar a la definición de clases en UML. Este tipo de modelo es el origen del proceso de transformaciones entre modelos que queremos crear. A continuación se detallan los aspectos más importantes del meta-modelo de Cassandra.
