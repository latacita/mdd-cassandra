...
A continuación, se ejecuta el caso de prueba creado en EUnit y se comprueba que la salida generada coincide con la esperada, que es la creada manualmente.
El único problema surge por un problema de defecto en la herramienta EUnit, la función de comparación de ficheros llamada assertEqualFiles obliga a que ambos ficheros sean estrictamente iguales por lo que para crear casos de prueba tanto el código de entrada de prueba como el código generado a testear han de ser iguales, espacios y saltos de linea incluidos.
