...
Los metamodelos son considerados instancias de estos lenguajes de modelado. Un ejemplo de metamodelo es la definición de UML [7]. En UML por ejemplo elementos como las clases, paquetes o atributos se pueden usar dentro del propio UML.
