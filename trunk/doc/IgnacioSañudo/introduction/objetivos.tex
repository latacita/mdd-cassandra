...
El objetivo de este proyecto de fin de carrera es la implementación de un generador de código que transforme un modelo UML en su correspondiente código ejecutable en Cassandra. Para ello, previa implementación del generador de código habrá que transformar el modelo UML a un modelo escrito en Cassandra. Por lo tanto necesitaremos desarrollar un metamodelo que describa el lenguaje de Cassandra y el metamodelo de UML. Dicho generador y dicha transformación se desarrollaran utilizando el enfoque y las técnicas que proporcionan el Desarrollo Dirigido por Modelos. Esta implementación será realizada con el framework que proporciona eclipse de modelado llamado EMF.
