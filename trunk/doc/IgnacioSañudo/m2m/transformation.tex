...
Una vez definido el meta-modelo de Cassandra utilizamos Epsilon Transformation Language (ETL) para establecer las reglas de transformación entre UML y Cassandra CQL. Recordamos que el lenguaje ETL es el lenguaje que utiliza Epsilon para la transformación entre modelos basado en reglas. A continuación se presenta una explicación de las reglas junto con el código correspondiente.
