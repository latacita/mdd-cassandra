...
Las reglas de transformación son definidas en (\cite{pablo:2013}). A continuación se detalla cómo se han implementado dichas reglas.
...
\end{footnotesize}
\end{center}
\caption{Regla de transformación atributo-columna}
