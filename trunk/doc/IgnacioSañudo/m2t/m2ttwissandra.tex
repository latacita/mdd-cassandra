...
Tras obtener el modelo Cassandra de Twissandra (figura~\ref{back:code:modeloTwissandra}) y tras la definición del generador de código se pone en funcionamiento la transformación modelo-código. El resultado de la transformación se detalla a continuación.
